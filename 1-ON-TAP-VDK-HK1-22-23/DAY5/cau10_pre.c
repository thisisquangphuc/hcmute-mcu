...
void main()
{
   ...
   while(true)
   {
      ...
      if(count>15)      count = count_pre;
      else if(count<0)  count = 0;
      else              
      { 
         //thoa man tat ca cac dieu khien 
         if(count_pre != count)
         {
            printf("%u",(unsigned int8)count);
         }
         count_pre = count;  //update lai gia tri cho count_pre
      }
